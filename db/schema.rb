...
ActiveRecord::Schema.define(version: 2020_04_10_152118) do
  ...
  create_table "whiskey_brands", force: :cascade do |t|
  ...
  create_table "whiskeys", force: :cascade do |t|
    t.bigint "whiskey_brand_id", null: false
    t.string "label", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["whiskey_brand_id"], name: "index_whiskeys_on_whiskey_brand_id"
  end

  add_foreign_key "reviews", "users"
  add_foreign_key "reviews", "whiskeys"
  add_foreign_key "whiskeys", "whiskey_brands"
end
